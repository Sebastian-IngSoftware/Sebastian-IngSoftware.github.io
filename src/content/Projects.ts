...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description: 'This is the page of my personal portfolio website built with Astro, a little bit of React and styled with Tailwind CSS, and implemented in TypeScript. It showcases my frontend skills, selected projects, and technical background.',
        tags: ['Astro', 'Tailwind', 'TypeScript', 'Git', 'Node', 'React']
    },
]
